...
Get the app from the [Visawise page](https://karthikkadambi.com/projects/visawise/) - enter your email there and you'll get a download link.
...
- A `.dmg` installer for macOS (Apple Silicon)
- `.tar.gz` and `.sig` files used internally by the app's auto-updater - not meant to be downloaded manually
